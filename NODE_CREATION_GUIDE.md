...
- Parameters: record identifiers, file limits, timeouts — never repository addresses or credentials (those live in the backend `.env`, see `docs/OAI_PMH_HARVEST.md`)
- Examples: OAI-PMH record fetch, OAI-PMH file download, catalog query
