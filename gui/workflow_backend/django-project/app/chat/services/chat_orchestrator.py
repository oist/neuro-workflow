...
DEFAULT_SYSTEM_PROMPT = (
    ...
    "  * DANDIQueryNode and the other *QueryNode nodes — hit the upstream API directly, "
    ...
    "{\"dataset_id\": \"000004\", \"source\": \"dandi\"}) instead of following add_node with "
    "a chain of update_node_parameter calls.\n"
