#!/usr/bin/env python3
"""
Generated workflow for project: my-create-test
"""
import sys
import os
...
def main():
    ...
    calc_1755603231630_33stzop06 = SimulateSonataNetworkNode("SonataNetworkSimulation")
    calc_1755603231630_33stzop06.configure(
    ...
    workflow = (
        WorkflowBuilder("neural_simulation")
            .add_node(calc_1755603231630_33stzop06)
            .build()
    )
